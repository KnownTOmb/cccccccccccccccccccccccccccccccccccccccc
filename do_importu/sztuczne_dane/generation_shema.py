...
def generated_table_data(table_name, generate_table_row_data, fill_table_row_with_column_data, column_to_replace):
    row_data_to_return = []
    def update_row_with_column_data(unique_data_column, unique_data):
    ...
    def get_already_generated_column_data(later_table_name, later_table_column_index, later_table_column_data):
    ...
    match table_name:
        ...
        case "tablica_ogloszeniowa":
            ...
            def opis():
                return fake_pl.text(max_nb_chars=random.randint(5, 2048))
